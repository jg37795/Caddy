window.GreenDetect.detect = function (data) {
  ...
  console.log("EXIT maxNear", maxNear.toFixed(3)); if (maxNear < 0.36) { console.log("EXIT maxNear", maxNear.toFixed(3)); return null; } console.log("SEED at", ((maxNearI % W) - W/2) * cs, (H/2 - ((maxNearI / W) | 0)) * cs);
