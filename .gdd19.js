window.GreenDetect.detect = function (data) {
  ...
  console.log("GROW loT/hiT:", loT.toFixed(2), hiT.toFixed(2), "blob cx/cy:", cx.toFixed(1), cy.toFixed(1), "nIn:", nIn); let conf = 0.35; console.log("STATS area", area.toFixed(0), "smRatio", smRatio.toFixed(2), "slIn", slIn.toFixed(1), "compact", compact.toFixed(2), "cd", cd.toFixed(1), "nHi", nHi, "chosen", chosen[oi]);
