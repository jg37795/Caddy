window.GreenDetect.detect = function (data) {
  ...
  console.log("EXIT maxNear", maxNear.toFixed(3)); console.log("SEED", (((maxNearI % W) - W/2) * cs).toFixed(0), ((H/2 - ((maxNearI / W) | 0)) * cs).toFixed(0), "score", maxNear.toFixed(2), "| origin score:", score[Math.round(H/2) * W + Math.round(W/2)].toFixed(2)); if (maxNear < 0.36) { console.log("EXIT maxNear", maxNear.toFixed(3)); return null; }
